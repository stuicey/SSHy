...
function fit(term) {
    term.screenElement.style.height = window.innerHeight
    var geometry = proposeGeometry(term);
    if (geometry) {
        term.resize(geometry.cols, geometry.rows);
        document.getElementById('termCols').value = geometry.cols; 
        document.getElementById('termRows').value = geometry.rows;
        transport.auth.mod_pty('window-change', termCols, termRows); 
    }
}
exports.fit = fit;
