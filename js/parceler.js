...
SSHyClient.parceler.prototype = {
    send: function(data, initial = false) {
    ...
    read_ibuffer: function(bytes = this.block_size) { // if we don't feed it any arguments we are only wanting one block anyway
