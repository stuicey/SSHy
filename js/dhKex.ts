...
import { ascii2hex, deflate_long, inflate_long, read_rng } from './src/utilities';
...
export class DiffieHellman {
    ...
    constructor(public transport: SSHyClientTransport, group, SHAVersion) {
    ...
    handleDHReply(r) {
        ...
        if (this.transport.settings.rsaCheckEnabled) {
            ...
            const shortKey = ascii2hex(SSHyClient.hash.MD5(host_key)).match(/.{2}/g);
        ...
        const K = this.f.modPow(this.x, this.p);
    ...
    generate_x() {
        let q = this.p.subtract(BigInteger.ONE);
